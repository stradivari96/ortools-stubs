...
class SatParameters(google___protobuf___message___Message):
    ...
    cp_model_max_num_presolve_operations = ... # type: int
    cp_model_probing_level = ... # type: int
    cp_model_use_sat_presolve = ... # type: bool
    expand_element_constraints = ... # type: bool
    expand_automaton_constraints = ... # type: bool
    expand_table_constraints = ... # type: bool
    merge_no_overlap_work_limit = ... # type: float
    merge_at_most_one_work_limit = ... # type: float
    presolve_substitution_level = ... # type: int
    ...
    max_all_diff_cut_size = ... # type: int
    add_lin_max_cuts = ... # type: bool
    max_integer_rounding_scaling = ... # type: int
    add_lp_constraints_lazily = ... # type: bool
    min_orthogonality_for_lp_constraints = ... # type: float
    max_cut_rounds_at_level_zero = ... # type: int
    max_consecutive_inactive_count = ... # type: int
    cut_max_active_count_value = ... # type: float
    cut_active_count_decay = ... # type: float
    cut_cleanup_target = ... # type: int
    new_constraints_batch_size = ... # type: int
    search_branching = ... # type: SatParameters.SearchBranching
    hint_conflict_limit = ... # type: int
    ...
    probing_period_at_root = ... # type: int
    ...
    stop_after_presolve = ... # type: bool
    num_search_workers = ... # type: int
    interleave_search = ... # type: bool
    interleave_batch_size = ... # type: int
    ...
    def __init__(self,
        *,
        ...
        cp_model_max_num_presolve_operations : typing___Optional[int] = None,
        ...
        expand_automaton_constraints : typing___Optional[bool] = None,
        expand_table_constraints : typing___Optional[bool] = None,
        merge_no_overlap_work_limit : typing___Optional[float] = None,
        merge_at_most_one_work_limit : typing___Optional[float] = None,
        presolve_substitution_level : typing___Optional[int] = None,
        ...
        max_all_diff_cut_size : typing___Optional[int] = None,
        add_lin_max_cuts : typing___Optional[bool] = None,
        ...
        max_cut_rounds_at_level_zero : typing___Optional[int] = None,
        max_consecutive_inactive_count : typing___Optional[int] = None,
        cut_max_active_count_value : typing___Optional[float] = None,
        cut_active_count_decay : typing___Optional[float] = None,
        cut_cleanup_target : typing___Optional[int] = None,
        new_constraints_batch_size : typing___Optional[int] = None,
        search_branching : typing___Optional[SatParameters.SearchBranching] = None,
        hint_conflict_limit : typing___Optional[int] = None,
        ...
        probing_period_at_root : typing___Optional[int] = None,
        ...
        stop_after_presolve : typing___Optional[bool] = None,
        num_search_workers : typing___Optional[int] = None,
        interleave_search : typing___Optional[bool] = None,
        interleave_batch_size : typing___Optional[int] = None,
        ...
        use_relaxation_lns : typing___Optional[bool] = None,
        ...
        use_implied_bounds : typing___Optional[bool] = None,
